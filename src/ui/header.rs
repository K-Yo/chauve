...
#[component]
fn LastUpdate(last_poll_time: String) -> Element {
...
#[component]
pub fn Header(active_alert: Option<Alert>, is_pinned: bool,last_poll_time: String, unpin: EventHandler) -> Element {
